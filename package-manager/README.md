...
| **Where to get help** | [GitHub Issues](https://github.com/posit-dev/images-package-manager/issues), [Images Discussion Board](https://github.com/posit-dev/images/discussions), [the Posit Community Forum](https://forum.posit.co/c/posit-professional-hosted/package-manager/21), [Posit Support](https://support.posit.co/hc/en-us) |
...
docker ps
# CONTAINER ID   IMAGE
# b8ae944b7f2d   docker.io/posit-dev/package-manager:2026.04.2
```
