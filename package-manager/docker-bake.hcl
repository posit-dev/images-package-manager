...
target "std" {
  ...
  labels = {
    "org.opencontainers.image.title" = "${title(replace(image_name, "-", " "))}"
    "org.opencontainers.image.description" = "Containerized edition of Posit ${title(replace(image_name, "-", " "))} ${builds.version}"
    ...
    "co.posit.image.name" = "${title(replace(image_name, "-", " "))}"
...
target "min" {
  ...
  labels = {
    "org.opencontainers.image.title" = "${title(replace(image_name, "-", " "))}"
    "org.opencontainers.image.description" = "Containerized minimal edition of Posit ${title(replace(image_name, "-", " "))} ${builds.version}"
    "org.opencontainers.image.version" = "${builds.version}"
